...
<body>
	...
	<main role="main">
		<div class="container">
			<form action="/jejuOseyo/Admin/AdmPwChange.do" method="post" class="form-horizontal">
				...
				<a class = "btn btn-secondary cancelBtn" href ="/jejuOseyo/Admin/AdminView.do?mid=${mid }">뒤로가기</a>
				<button type="submit" class="btn btn-success" onclick="return newPWChk()">비밀번호 변경</button>
				</div>
			</form>
		</div>
	</main>
