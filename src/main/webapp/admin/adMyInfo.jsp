...
<body>
	...
	<main role="main">
		<div class="container">
			...
			<form action="/jejuOseyo/Admin/AdminModify.do" method="post"
    ...
    mphoneInput.addEventListener("input", function () {
        ...
        if (!koreanPhoneNumberPattern.test(mphone)) {
            mphoneInput.setCustomValidity("유효하지 않은 전화번호입니다.");
        } else {
            mphoneInput.setCustomValidity("");
        }
    });
</script>
				...
				<div class="button-container">
					...
					<input type="hidden" name="mid" id="mid" value="${view.mid}">
					<button type="submit" class="btn btn-info regBtn"
						onclick="setEmailValue();">수정</button>
					<a class="btn btn-success" href="../admin/adPWChange.jsp">비밀번호
						변경</a>
