...
<div class="jumbotron" style="background-color:#FFFBC9" >
	...
	<div class="container">
		...
		<form action="/jejuOseyo/Room/RoomAdd.do" method="post" enctype="multipart/form-data" class="form-horizontal">
			...
			<label class="col-sm-2">
				...
				<div class="col-sm-3">
					<input type="text" name="zipNo" id="zipNo" readonly class="form-control">
				</div> 
				<div class="col-sm-2">
