...
<body>
	...
	<main role="main">
		<div class="container">
			<form action="/jejuOseyo/Common/HpwModify.do" method="post"
				...
				<div class="form-group row">
					...
					<div class="col-sm-8">
						<input type="password" name="newpw" id="newpw"
							class="form-control" placeholder="알파벳,숫자,특수문자 포함 8글자 이상" required>
					</div>
				</div>
				...
				<input type="hidden" name="hid" value="${hpw_hid }">

				<div class="button-container">
					<button type="submit" class="btn btn-info regBtn"
						style="background-color: #649E77" onclick="return newPWChk();">비밀번호
						변경</button>
				</div>
