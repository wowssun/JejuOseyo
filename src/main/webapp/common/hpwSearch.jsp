...
<body>
	...
	<main role="main">
		<div class="container">
			<form action="/jejuOseyo/Common/HpwFind.do" method="post" class="form-horizontal">
			...
			<div class="button-container">
				<input type="submit" class="btn btn-info" style ="background-color: #649E77" value="다음">
</div>
