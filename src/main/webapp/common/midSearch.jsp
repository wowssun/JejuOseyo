...
<body>
	...
	<main role="main">
		<div class="container">
			<form action="/jejuOseyo/Common/MidFind.do" method="post" class="form-horizontal">
			...
			<div class="form-group row">
				...
				<input type="submit" class="btn btn-info" style ="background-color: #649E77" value="아이디찾기">
</div>
